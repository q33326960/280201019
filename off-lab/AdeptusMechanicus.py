...
print("One day the crude biomass that you call a temple will wither," + Fore.RESET + Fore.RED + " and you will beg my kind to save you" + Fore.RESET )
print(Fore.RED + Style.DIM + "But I'm already saved. for the Machine is immortal." + Fore.RESET + Style.RESET_ALL)
print(Fore.LIGHTYELLOW_EX + "Even in death I serve the Omnissiah.")
